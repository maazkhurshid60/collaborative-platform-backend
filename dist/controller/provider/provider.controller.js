...
exports.getTotalProviders = exports.updateProvider = exports.deletProvider = exports.getAllUnblockProviders = void 0;
...
const getAllUnblockProviders = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const allProviders = yield db_config_1.default.provider.findMany({
...
exports.getAllUnblockProviders = getAllUnblockProviders;
const getTotalProviders = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 10;
    const skip = (page - 1) * limit;
    ...
    res.status(http_status_codes_1.StatusCodes.OK).json(new apiResponse_1.ApiResponse(http_status_codes_1.StatusCodes.OK, { totalDocument: allProviders.length, providers: allProviders }, "All Providers fetched successfully"));
}));
exports.getTotalProviders = getTotalProviders;
