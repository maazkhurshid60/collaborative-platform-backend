      ...
      <div class="wrapper">
        <div class="main">
          <div class="header">
            ...
            <p class="header-title">Security Center</p>
          </div>
          ...
          <div class="content">
            ...
            <div class="cta-container">
              <a href="${frontendUrl}/reset-password/${token}" class="cta-button">Reset Password</a>
            </div>
            ...
            <div style="background-color: #f0fdfa; border-left: 4px solid #14b8a6; padding: 20px; border-radius: 0 8px 8px 0; margin-bottom: 32px;">
              <p style="font-size: 14px; color: #4b5563; margin: 0; line-height: 1.5;">
                <strong>Security Note:</strong> This link will expire in <strong>1 hour</strong>. If you did not request a password reset, please ignore this email.
              </p>
            </div>
        ...
        <div class="footer">
          <p style="margin: 0;">
            This is a secure automated message regarding your account.
          </p>
        </div>
      </div>
    </body>
