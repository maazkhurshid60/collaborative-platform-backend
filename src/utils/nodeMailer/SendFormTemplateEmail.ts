...
export const sendFormTemplateEmail = async (
  toEmail: string,
  clientName: string,
  providerName: string,
  ...
  const htmlContent = `
    ...
    <head>
      ...
      <title>Form Template Shared With You</title>
      <style>
      ...
      <div class="wrapper">
        <div class="main">
          <div class="header">
            ...
            <p class="header-title">Form Invitation</p>
          </div>
          
          <div class="content">
            <h1 class="greeting">New Form Shared</h1>
            <p class="intro-text">
              Hello <strong>${clientName}</strong>,<br><br>
              <span class="highlight">${providerName}</span> has shared a form template with you on the Kolabme platform.
            </p>

            <div class="form-info-box">
              <p class="form-info-title">${templateTitle}</p>
              <p class="form-info-subtitle">Shared by ${providerName}</p>
            </div>
            
            <p class="intro-text">
              Please click the button below to view and complete the form:
            </p>

            <div class="cta-container">
              <a href="${secureLink}" class="cta-button">Fill Out Form</a>
            </div>
