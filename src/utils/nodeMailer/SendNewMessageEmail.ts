      ...
      <div class="wrapper">
        <div class="main">
          <div class="header">
            ...
            <p class="header-title">New Message Notification</p>
          </div>
          
          <div class="content">
            <h1 class="greeting">You have new messages</h1>
            <p class="intro-text">
              <span class="highlight">${senderName}</span> has sent you new messages on <strong>Kolabme</strong>. Use the link below to securely access the chat and reply.
            </p>
            ...
            <div class="cta-container">
              <a href="${chatLink}" class="cta-button">View Messages</a>
            </div>
