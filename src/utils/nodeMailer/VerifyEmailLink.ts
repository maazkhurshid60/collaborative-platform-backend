...
export const sendVerifyEmailLink = async (
        ...
        <div class="main">
          ...
          <div class="content">
            ...
            <p class="intro-text">
              ...
              Thanks for joining Kolabme! To unlock all features of the platform, please verify your email address by clicking the button below. This link will expire in 24 hours.
            </p>
  ...
  await transporter.sendMail({
    ...
    to: toEmail,
    subject: "Verify your email address - Kolabme",
    html: htmlContent,
  });
};
