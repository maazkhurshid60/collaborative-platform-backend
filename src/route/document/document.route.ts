...
import { addDocumentApi, documentSharedWithClientApi, deleteDocumentApi, documentSignByClientApi, getAllDocumentApi, getAllSharedDocumentWithClientApi, getAllMasterDocumentsApi, getDocumentRecipientsApi, } from "../../controller/document/document.controller";
...
documentRouter.get("/list-all", getAllMasterDocumentsApi)
documentRouter.get("/:id/recipients", getDocumentRecipientsApi)
